...
<body class=" theme-blue">
    	<div class="main-content clearfix">	     
			<div class="row clearfix">
				<form:form method="post" action="${pageContext.request.contextPath}/student/StudentAdd" modelAttribute="stuVO" id="userForm">
				<!-- <form id="tab" action="${pageContext.request.contextPath}/users/add" method="post"> -->
			        <div class="form-group">
			        	...
			        	<form:input path="examStuName" cssClass=" form-control required" />
			        ...
			        <div class="form-group">
			            <label class="col-sm-4 control-label">Done<form:errors path="examStuDone" cssStyle="color:red" cssClass="error"/></label>
			            <form:select path="examStuDone" items="${done}" cssClass="form-control"/>
			       </div> 
			 		<div>
