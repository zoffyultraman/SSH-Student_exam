...
$.widget( "ui.combobox", {
    _create: function() {
        ...
        .autocomplete({
            ...
            close: function(event, ui) {
                if(input.showLabel != null && input.showLabel == false){
                    var selectedOption = select.children( ":selected" );
                    input.val((selectedOption.val()) ? selectedOption.val() : "");
                }
            },
    ...
    change: function(event){
        this.input.bind( "autocompletechange", event);
    },
    clear: function(){
        this.element.val("");
        this.input.val("");
    ...
    showLabel: function(value){
        this.input.showLabel = value;
    },
    value: function(value){
        if(value != null){
            this.element.val(value);
            var selected = this.element.children( ":selected" );
            if(this.input.showLabel != null && this.input.showLabel == false){
                this.input.val((selected.val()) ? selected.val() : "");
            }else{
                this.input.val((selected.val()) ? selected.text() : "");
            }
